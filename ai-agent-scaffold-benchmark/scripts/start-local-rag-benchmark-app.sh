...
export AI_CONTEXT_ENABLED="${AI_CONTEXT_ENABLED:-false}"
export AI_CONTEXT_KAFKA_ENABLED="${AI_CONTEXT_KAFKA_ENABLED:-false}"
...
exec "$JAVA_BIN" -jar "$APP_JAR" \
  ...
  "--ai.context.enabled=$AI_CONTEXT_ENABLED" \
  "--ai.context.kafka.enabled=$AI_CONTEXT_KAFKA_ENABLED" \
