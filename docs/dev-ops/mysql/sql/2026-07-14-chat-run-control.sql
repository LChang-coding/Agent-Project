CREATE TABLE chat_run (
    ...
    rag_mode VARCHAR(16) NOT NULL DEFAULT 'OFF' COMMENT '运行RAG模式快照',
    rag_policy_revision BIGINT NOT NULL DEFAULT 0 COMMENT '运行RAG策略版本快照',
    rag_binding_ids_json JSON NULL COMMENT '运行有效RAG绑定ID快照',
